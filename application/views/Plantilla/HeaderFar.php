          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="hidden-xs">Especialista</span>
              </a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="#"><i class="fa fa-circle-o text-red"></i> <span>Zonas Afectadas</span></a></li>
          <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> <span>Enfermedades Frecuentes</span></a></li>
        </ul>
      </section>
      <!-- /.sidebar -->
    </aside>
