              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  ...
                  <div class="pull-right">
                    <a href="<?php echo base_url() ?>Usuario/cerrar_sesion" class="btn btn-default btn-flat">Cerrar Sesion</a>
                  </div>
                </li>
              </ul>
            </li>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="../agenda/Paciente/Index"><i class="fa fa-circle-o"></i> Mostrar</a></li>
              <li><a href="../agenda/Paciente/Agregar"><i class="fa fa-circle-o"></i> Agregar</a></li>
            </ul>
          </li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="../agenda/Perfil/Index"><i class="fa fa-circle-o"></i> Mostrar</a></li>
              <li><a href="../agenda/Perfil/Agregar"><i class="fa fa-circle-o"></i> Agregar</a></li>
            </ul>
          </li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="../agenda/Usuario/Index"><i class="fa fa-circle-o"></i> Mostrar</a></li>
              <li><a href="../agenda/Usuario/Agregar"><i class="fa fa-circle-o"></i> Agregar</a></li>
            </ul>
          </li>
        
          <li class="header">REPORTES</li>
          <li><a href="../agenda/Reportes/Droguerias"><i class="fa fa-circle-o text-red"></i> <span>Zonas Afectadas</span></a></li>
          <li><a href="../agenda/Reportes/Enfermedades"><i class="fa fa-circle-o text-yellow"></i> <span>Enfermedades Frecuentes</span></a></li>
        </ul>
      </section>
      <!-- /.sidebar -->
    </aside>
